...
if [ "$color_prompt" = yes ]; then
	if [[ ${EUID} == 0 ]]; then
		...
		PS1='${debian_chroot:+($debian_chroot)}\[\033[01;31m\]\u\[\033[00;37m\]@\[\033[01;37m\]\h \[\033[01;33m\]\w \[\033[01;36m\]\$ \[\033[00m\]'
	else
		PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u\[\033[00;37m\]@\[\033[01;37m\]\h \[\033[01;33m\]\w \[\033[01;36m\]\$ \[\033[00m\]'
	fi
else
